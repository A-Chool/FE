...
export const loadMemberList = (week) => {
  return function (dispatch, getState, { history }) {
    ...
    axios.get(`https://www.a-chool.com:443/api/admin/teams/noMember/${week}`
...
export const addMemberList = (teamId, userId) => {
  return function (dispatch, getState, {history}) {
    ...
    axios({
      method: "post",
      url: `https://www.a-chool.com:443/api/admin/teams/members`,
      data: {
      teamId : teamId,
      userId : userId
    },
...
export const deleteMemberList = (memberId, userId) => {
  return function (dispatch, getState, {history}) {
    ...
    axios({
      method: "delete",
      url: `https://www.a-chool.com:443/api/admin/teams/members/${memberId}`,
      // data : {userId : userId},     
      headers: {
