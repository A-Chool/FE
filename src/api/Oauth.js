...
export const NAVER_AUTH_URL = `https://nid.naver.com/oauth2.0/authorize?client_id=${process.env.REACT_APP_NAVER_CLIENT_ID}&redirect_uri=${naver_redirect_uri}&response_type=code&state=STATE_STRING`;
